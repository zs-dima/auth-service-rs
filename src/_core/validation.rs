...
//!
//! Additional domain-level validation can be added here for business rules
...
/// Domain validation utilities beyond proto validation.
/// These provide additional business rule validation.
#[allow(dead_code)] // Public API validation utilities
pub mod domain {
    use tonic::Status;
    ...
    pub fn validate_email(email: &str) -> Result<(), Status> {
        ...
        // Basic sanity check (proto validation should handle format)
